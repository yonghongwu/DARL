...
PATH = "/new_database/wuyonghuang/Dataset_XCAD/train/trainA"
...
for i in trange(0, 1621):
    ...
    '''
    aug = Compose([
        PiecewiseAffine(scale=(0.09, 0.13), nb_rows=4, nb_cols=4, cval=0, mode='constant', always_apply=False, p=1),
        Rotate(limit=30, p=0.5)], p=1)
...
img = cv2.imread("/new_database/wuyonghuang/Dataset_XCAD/train/trainA01609.png")
plt.imshow(img*255)
plt.show()"""